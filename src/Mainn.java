...
public class Mainn extends JFrame {
	...
	public Mainn() {
		...
		try (BufferedReader brDegre = new BufferedReader(new FileReader(filenameDegre))) {
            ...
            e.printStackTrace(); // Afficher l'erreur d'entrée/sortie
        }  ;
        
        
        try (BufferedReader brDegreF3 = new BufferedReader(new FileReader(filenameDegreF3))) {
            String lineDegreF3 = brDegreF3.readLine(); // Lire la première ligne
            savedValueF3 = Integer.parseInt(lineDegreF3.trim());
              
        } catch (IOException es) {
            es.printStackTrace(); // Afficher l'erreur d'entrée/sortie
        }  ;
      ...
      //----------------------------------------------------------
			...
			public void actionPerformed(ActionEvent arg0) {
		        ...
		        showTableButton.addActionListener(new ActionListener() {
		            ...
		            public void actionPerformed(ActionEvent e) {
		            	...
		            	EfficiencyTable dialog = new EfficiencyTable(eff);  // Remplacez parentFrame par le nom de votre fenêtre principale
		...
		//----------fichier pour sauvegarder la formule efficacité utilisée
					...
					public void actionPerformed(ActionEvent arg0) {	
						...
						for(int jS=0;jS<size;jS++) {
  		    			...
  		    			Float enrgjeff	= Float.parseFloat(enrgyNuc);
  		    			  //----la lecture de fichier pour des coefficients d'efficacité
