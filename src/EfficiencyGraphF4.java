...
public class EfficiencyGraphF4 extends JPanel {	
	...
	static ChartPanel chartPanelEfficiency, chartPanelEfficiency2, chartPanelEfficiencyF4;
	static int cali=0;
	...
	public EfficiencyGraphF4() throws IOException {
        XYDataset dataset = createDataset();
        chart = createChart(dataset);       
        chartPanelEfficiencyF4 = new ChartPanel(chart, true, true, true, false, true){  
        	@Override
            public Dimension getPreferredSize() {
                return new Dimension(Formule4Efficiency.subPanelF4.getWidth(), Formule4Efficiency.subPanelF4.getHeight());
            }        	
        };        
        chartPanelEfficiencyF4.setFillZoomRectangle(false);
        chartPanelEfficiencyF4.setMouseWheelEnabled(true);
        add(chartPanelEfficiencyF4);
  //--------------------------------ZOOM-ET-DEPLACEMENT----------------------------------------------------     
       
        double up=domainAxis.getUpperBound();
        chartPanelEfficiencyF4.addChartMouseListener(new ChartMouseListener() {

        	@Override
            public void chartMouseClicked(ChartMouseEvent cme) {
        		
        		Point2D po = chartPanelEfficiencyF4.translateScreenToJava2D(cme.getTrigger().getPoint());
                Rectangle2D plotArea = chartPanelEfficiencyF4.getScreenDataArea();
...
//---------------------------------Minimize_zoom-----------------------------------------     
        ...
        chartPanelEfficiencyF4.getPopupMenu().add(new JMenuItem("Minimize zoom")).addActionListener(new ActionListener() {
...
//---------------------------------Move_down-----------------------------------------     
        ...
        chartPanelEfficiencyF4.getPopupMenu().add(new JMenuItem("Move down")).addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e2) {
	...
	private XYDataset createDataset() throws IOException {
		...
		//------------nucléides de calibrade éfficacié---------------
	     ...
	     try (BufferedReader breffk = new BufferedReader(new FileReader(Mainn.filenameEfficienF4))) {   	 
	    	        String line;
	...
	//_______________________________________________________________	
	 ...
	 for(int j=0;j<Mainn.lengthofdata-Mainn.offsetofdata;j=j+50) {
		 ...
		 //---------Calcul de la formule eff-------------
		 
		 String valeurEffi1F4 = Mainn.textField1tpeF4.getText();
		 double valeurDoubleEffi1F4 = Double.parseDouble(valeurEffi1F4);
		 
		 String valeurEffi2F4 = Mainn.textField2tpeF4.getText();
		 double valeurDoubleEffi2F4 = Double.parseDouble(valeurEffi2F4);
		 
		 String valeurEffi3F4 = Mainn.textField3tpeF4.getText();
		 double valeurDoubleEffi3F4 = Double.parseDouble(valeurEffi3F4);
		 
		 double Eff = Math.exp(valeurDoubleEffi1F4+ valeurDoubleEffi2F4*EnergirForEffici+valeurDoubleEffi3F4*Math.pow(EnergirForEffici, 2));
