...
public class EfficiencyGraphF3 extends JPanel {	
	...
	static ChartPanel chartPanelEfficiency, chartPanelEfficiency2, chartPanelEfficiencyF3;
	static int cali=0;
	...
	public EfficiencyGraphF3() throws IOException {
        XYDataset dataset = createDataset();
        chart = createChart(dataset);       
        chartPanelEfficiencyF3 = new ChartPanel(chart, true, true, true, false, true){  
        	@Override
            public Dimension getPreferredSize() {
                return new Dimension(Formule3Efficiency.subPanelF3.getWidth(), Formule3Efficiency.subPanelF3.getHeight());
            }        	
        };        
        chartPanelEfficiencyF3.setFillZoomRectangle(false);
        chartPanelEfficiencyF3.setMouseWheelEnabled(true);
        add(chartPanelEfficiencyF3);
  //--------------------------------ZOOM-ET-DEPLACEMENT----------------------------------------------------     
       
        double up=domainAxis.getUpperBound();
        chartPanelEfficiencyF3.addChartMouseListener(new ChartMouseListener() {

        	@Override
            public void chartMouseClicked(ChartMouseEvent cme) {
        		
        		Point2D po = chartPanelEfficiencyF3.translateScreenToJava2D(cme.getTrigger().getPoint());
                Rectangle2D plotArea = chartPanelEfficiencyF3.getScreenDataArea();
...
//---------------------------------Minimize_zoom-----------------------------------------     
        ...
        chartPanelEfficiencyF3.getPopupMenu().add(new JMenuItem("Minimize zoom")).addActionListener(new ActionListener() {
...
//---------------------------------Move_down-----------------------------------------     
        ...
        chartPanelEfficiencyF3.getPopupMenu().add(new JMenuItem("Move down")).addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e2) {
	...
	private XYDataset createDataset() throws IOException {
		...
		//------------nucléides de calibrade éfficacié---------------
	     ...
	     try (BufferedReader breffk = new BufferedReader(new FileReader(Mainn.filenameEfficienF3))) {   	 
	    	        String line;
	...
	//_______________________________________________________________	
	 ...
	 for(int j=0;j<Mainn.lengthofdata-Mainn.offsetofdata;j=j+50) {
		...
		if(EnergirForEffici>1 ) {
		 ...
		 String valeurEffi1 = Mainn.textField1tpeF3.getText();
		 double valeurDoubleEffi1 = Double.parseDouble(valeurEffi1);
		 
		 String valeurEffi2 = Mainn.textField2tpeF3.getText();
		 double valeurDoubleEffi2 = Double.parseDouble(valeurEffi2);
		 
		 String valeurEffi3 = Mainn.textField3tpeF3.getText();
		 double valeurDoubleEffi3 = Double.parseDouble(valeurEffi3);
		 
		 String valeurEffi4 = Mainn.textField4tpeF3.getText();
		 double valeurDoubleEffi4 = Double.parseDouble(valeurEffi4);
		 
		 String valeurEffi5 = Mainn.textField5tpeF3.getText();
		 double valeurDoubleEffi5 = Double.parseDouble(valeurEffi5);
		 
		 String valeurEffi6 = Mainn.textField6tpeF3.getText();
		 double valeurDoubleEffi6 = Double.parseDouble(valeurEffi6);
		 
		 
		 double Eff = valeurDoubleEffi1 + valeurDoubleEffi2 * EnergirForEffici + valeurDoubleEffi3 * Math.pow(EnergirForEffici, 2) + valeurDoubleEffi4 * Math.pow(EnergirForEffici, 3) 
		              + valeurDoubleEffi5 * Math.pow(EnergirForEffici, 4) + valeurDoubleEffi6 * Math.pow(EnergirForEffici, 5);
